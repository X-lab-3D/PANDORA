...
foreach i (` cat $argv[2] `)
  ...
  /home/dariom/alembick_backup/ProFitV3.3/bin/profit <<_Eod_ |grep RMS |tail -1 >>l-rmsd_xray.disp
    refe $refe
    mobi $i
    ratoms $atoms
    atom $atoms
...
awk '{if ($1 == "RMS:") {printf "%8.3f ",$2} else {printf "\n %s ",$1}}' l-rmsd_xray.disp |grep pdb |awk '{print $1,$2}' > CA-l-RMSD.dat
#sort -nk2 CA-l-RMSD.dat > CA-l-RMSD_sorted.dat
