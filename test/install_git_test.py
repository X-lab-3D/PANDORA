...
os.system('mkdir ./Databases/data')
os.system('mkdir ./Databases/data/csv_pkl_files')
os.system('mkdir ./Databases/data/PDBs')
os.system('mkdir ./Databases/data/PDBs/pMHCI')
os.system('mkdir ./Databases/data/PDBs/pMHCII')
os.system('mkdir ./Databases/data/PDBs/Bad')
os.system('mkdir ./Databases/data/PDBs/Bad/pMHCI')
os.system('mkdir ./Databases/data/PDBs/Bad/pMHCII')
os.system('mkdir ./Databases/data/PDBs/IMGT_retrieved/')
