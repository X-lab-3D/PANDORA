...
os.system('mkdir ./PANDORA_files/default')
os.system('mkdir ./PANDORA_files/default/csv_pkl_files')
os.system('mkdir ./PANDORA_files/default/PDBs')
os.system('mkdir ./PANDORA_files/default/PDBs/pMHCI')
os.system('mkdir ./PANDORA_files/default/PDBs/pMHCII')
os.system('mkdir ./PANDORA_files/default/PDBs/Bad')
os.system('mkdir ./PANDORA_files/default/PDBs/Bad/pMHCI')
os.system('mkdir ./PANDORA_files/default/PDBs/Bad/pMHCII')
os.system('mkdir ./PANDORA_files/default/PDBs/IMGT_retrieved/')
