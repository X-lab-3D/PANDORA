...
from PANDORA.junk.parsing import url_protocols
from PANDORA.junk.parsing import structures_parser
...
class Database:
    ...
    def download_data(self):
        ...
        self.__IDs_list_MHCI = url_protocols.download_ids_imgt('MH1', out_tsv='all_MH1_IDs.tsv') #todo fix type
